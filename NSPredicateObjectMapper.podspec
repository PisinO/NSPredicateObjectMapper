...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Ondřej Pišín/NSPredicateObjectMapper'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ondřej Pišín' => 'ondrej.pisin@gmail.com' }
  s.source           = { :git => 'https://github.com/Ondřej Pišín/NSPredicateObjectMapper.git', :tag => s.version.to_s }
